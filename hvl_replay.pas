...
begin
  ...
  // Position list
  DebugLn('initializing #%d list positions', [ht^.ht_PositionNr]);
  ...
  // Tracks
  DebugLn('initializing #%d tracks', [ht^.ht_TrackNr]);
  ...
  // Instruments
  DebugLn('initializing #%d instruments', [ht^.ht_InstrumentNr]);
...
begin
  ...
  begin
    ...
    voice^.vc_MixSource         := @voice^.vc_VoiceBuffer[0];    // FPC: explicit
  end;
  ...
  begin
    ...
    voice^.vc_RingMixSource         := @voice^.vc_RingVoiceBuffer[0]; // FPC: explicit
  end;
end;
